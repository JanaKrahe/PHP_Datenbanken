...
<p><span class="error">* Pflichtfelder</span></p>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      ...
      <input type="submit" value="Registrieren" name="Registrieren">
         ...
         <!-- Wenn alle Felder gefüllt sind verschlüssel das Passwort -->

         <!-- nach der Verschlüsselung soll die Datenbank gefüllt werden -->

         <!-- Nach der Datenbank kommt in die Console eine ausgabe und die Anmeldeseite wird geöffnet -->
  <fieldset>
  <form method="post">
      <label>
